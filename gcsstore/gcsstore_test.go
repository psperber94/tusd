...
import (
	...
	"github.com/psperber94/tusd/gcsstore"
)

// go:generate mockgen -destination=./gcsstore_mock_test.go -package=gcsstore_test github.com/psperber94/tusd/gcsstore GCSReader,GCSAPI
